...
public class BuiltinSchemaTypeSystem extends SchemaTypeLoaderBase implements SchemaTypeSystem
{
    ...
    // MOD AR: Modify many base types to use Java primitive types instead of XMLBeans objects
    public static final String DATETIME_JAVATYPE = "net.opengis.IDateTime";
    ...
    private BuiltinSchemaTypeSystem()
    {
        ...
        // UR types
        setupBuiltin(SchemaType.BTC_ANY_TYPE, "anyType", "java.lang.Object");
        setupBuiltin(SchemaType.BTC_ANY_SIMPLE, "anySimpleType", "java.lang.Object");

        // primitives
        setupBuiltin(SchemaType.BTC_BOOLEAN, "boolean", "boolean");
        setupBuiltin(SchemaType.BTC_BASE_64_BINARY, "base64Binary", "byte[]");
        setupBuiltin(SchemaType.BTC_HEX_BINARY, "hexBinary", "byte[]");
        setupBuiltin(SchemaType.BTC_ANY_URI, "anyURI", "java.lang.String");
        setupBuiltin(SchemaType.BTC_QNAME, "QName", "javax.xml.namespace.QName");
        setupBuiltin(SchemaType.BTC_NOTATION, "NOTATION", "java.lang.String");
        setupBuiltin(SchemaType.BTC_FLOAT, "float", "float");
        setupBuiltin(SchemaType.BTC_DOUBLE, "double", "double");
        setupBuiltin(SchemaType.BTC_DECIMAL, "decimal", "double");
        setupBuiltin(SchemaType.BTC_STRING, "string", "java.lang.String");

        setupBuiltin(SchemaType.BTC_DURATION, "duration", DATETIME_JAVATYPE);
        setupBuiltin(SchemaType.BTC_DATE_TIME, "dateTime", DATETIME_JAVATYPE);
        setupBuiltin(SchemaType.BTC_TIME, "time", DATETIME_JAVATYPE);
        setupBuiltin(SchemaType.BTC_DATE, "date", DATETIME_JAVATYPE);
        setupBuiltin(SchemaType.BTC_G_YEAR_MONTH, "gYearMonth", "short");
        setupBuiltin(SchemaType.BTC_G_YEAR, "gYear", "short");
        setupBuiltin(SchemaType.BTC_G_MONTH_DAY, "gMonthDay", "short");
        setupBuiltin(SchemaType.BTC_G_DAY, "gDay", "short");
        setupBuiltin(SchemaType.BTC_G_MONTH, "gMonth", "short");

        // derived numerics
        setupBuiltin(SchemaType.BTC_INTEGER, "integer", "int");
        setupBuiltin(SchemaType.BTC_LONG, "long", "long");
        setupBuiltin(SchemaType.BTC_INT, "int", "int");
        setupBuiltin(SchemaType.BTC_SHORT, "short", "short");
        setupBuiltin(SchemaType.BTC_BYTE, "byte", "byte");
        setupBuiltin(SchemaType.BTC_NON_POSITIVE_INTEGER, "nonPositiveInteger", "int");
        setupBuiltin(SchemaType.BTC_NEGATIVE_INTEGER, "negativeInteger", "int");
        setupBuiltin(SchemaType.BTC_NON_NEGATIVE_INTEGER, "nonNegativeInteger", "int");
        setupBuiltin(SchemaType.BTC_POSITIVE_INTEGER, "positiveInteger", "int");
        setupBuiltin(SchemaType.BTC_UNSIGNED_LONG, "unsignedLong", "long");
        setupBuiltin(SchemaType.BTC_UNSIGNED_INT, "unsignedInt", "int");
        setupBuiltin(SchemaType.BTC_UNSIGNED_SHORT, "unsignedShort", "short");
        setupBuiltin(SchemaType.BTC_UNSIGNED_BYTE, "unsignedByte", "byte");

        // derived strings
        setupBuiltin(SchemaType.BTC_NORMALIZED_STRING, "normalizedString", "java.lang.String");
        setupBuiltin(SchemaType.BTC_TOKEN, "token", "java.lang.String");
        setupBuiltin(SchemaType.BTC_NAME, "Name", "java.lang.String");
        setupBuiltin(SchemaType.BTC_NCNAME, "NCName", "java.lang.String");
        setupBuiltin(SchemaType.BTC_LANGUAGE, "language", "java.lang.String");
        setupBuiltin(SchemaType.BTC_ID, "ID", "java.lang.String");
        setupBuiltin(SchemaType.BTC_IDREF, "IDREF", "java.lang.String");
        setupBuiltin(SchemaType.BTC_IDREFS, "IDREFS", "java.lang.String[]");
        setupBuiltin(SchemaType.BTC_ENTITY, "ENTITY", "java.lang.String");
        setupBuiltin(SchemaType.BTC_ENTITIES, "ENTITIES", "java.lang.String[]");
        setupBuiltin(SchemaType.BTC_NMTOKEN, "NMTOKEN", "java.lang.String");
        setupBuiltin(SchemaType.BTC_NMTOKENS, "NMTOKENS", "java.lang.String[]");
